...
export default {
  ...
  methods: {
    ...
    async fetchHqOrders() {
      try {
        const response = await axios.get('http://localhost:8888/inventory/hq/orders');
    ...
    async fetchHqStock() {
      try {
        const response = await axios.get('http://localhost:8888/inventory/hq/stock');
    ...
    async approveOrder(hqInventoryId) {
      ...
      try {
        ...
        const response = await axios.post('http://localhost:8888/inventory/in/hq', params);
    ...
    async chargeStockFromFactory(itemId) {
      ...
      try {
        ...
        const response = await axios.post('http://localhost:8888/inventory/hq/stock/charge', params);
        if (response.status === 200) {
          alert("🎉 " + response.data);
