...
<div v-if="isModalOpen" class="modal-overlay">
  <div class="modal-content">
    ...
    <div class="form-group">
      ...
      <input
        type="text"
        v-model="promotionForm.eventName"
      />
    </div>
    ...
    <div class="form-group">
      <label>이벤트 내용</label>
      <textarea
        v-model="promotionForm.eventContent"
      ></textarea>
    </div>
...
<div v-if="isDetailModalOpen" class="modal-overlay">
  <div class="modal-content">
    ...
    <div 
 class="form-group"
 v-if="selectedPromotion.imageUrl"
>
<label>이벤트 이미지</label>
...
import pointEvent from '../image/event/pointevent.png'
import dark from '../image/event/dark.png'
import mirrorball from '../image/event/mirrorball.png'
import moon from '../image/event/moon.png'
...
const getImageUrl = (imageCode) => {
  ...
  return imageList.find(img => img.code === imageCode)?.url
}
...
const selectImage = (img) => {
  ...
  promotionForm.value.imageUrl = img.url

  console.log(promotionForm.value)
...
const paginatedPromotions = computed(() => {
  ...
  return promotions.value.slice(start, start + itemsPerPage)
})
...
.form-group input, .form-group select,.form-group textarea  { padding: 8px 12px; border: 1px solid #e2e8f0; border-radius: 6px; font-size: 14px; }
